/*
 *	Note: This raytracing shader was not written by me, rather ported from a shadertoy
 *	project, so that it works as this fragment shader.
 *	This project's licensing therefore doesn't apply to this file, and you can find it's
 *	original code at the link below.
